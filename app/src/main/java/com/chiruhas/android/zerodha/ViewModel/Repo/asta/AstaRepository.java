...
public class AstaRepository {
    ...
    public AstaRepository() {
        retrofit = new Retrofit.Builder().baseUrl("http://ec2-13-235-73-156.ap-south-1.compute.amazonaws.com:5000/astha/").addConverterFactory(GsonConverterFactory.create()).build();
