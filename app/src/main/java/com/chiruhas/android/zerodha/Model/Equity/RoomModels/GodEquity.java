package com.chiruhas.android.zerodha.Model.Equity.RoomModels;
...
@Entity(tableName = "equity_table")
public class GodEquity {
        ...
        public GodEquity(double margin, double co_lower, float mis_multiplier, String tradingsymbol, double co_upper, int nrml_margin, int mis_margin) {
            this.margin = margin;
